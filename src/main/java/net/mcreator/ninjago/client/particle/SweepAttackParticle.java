...
package net.mcreator.ninjago.client.particle;
...
public class SweepAttackParticle extends TextureSheetParticle {
	public static SweepAttackParticleProvider provider(SpriteSet spriteSet) {
		return new SweepAttackParticleProvider(spriteSet);
	}

	public static class SweepAttackParticleProvider implements ParticleProvider<SimpleParticleType> {
		private final SpriteSet spriteSet;

		public SweepAttackParticleProvider(SpriteSet spriteSet) {
